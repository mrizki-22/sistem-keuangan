...
const menuList = [
  ...
  },
  {
    ...
    children: [
      ...
      { menu: "Detail Tagihan", route: ROUTES.TRANSAKSI.DETAIL_TAGIHAN, showInNavbar: false },
      ...
      { menu: "Detail Deposit", route: ROUTES.TRANSAKSI.DETAIL_DEPOSIT, showInNavbar: false },
